...
class VerizonDriver:
    ...
    def UserInformation_SaveInfo(self):
        ...
        self.browser.searchForElement(by=By.XPATH,value=yourDevicesHeaderXPath,timeout=60,testClickable=True,testLiteralClick=True,raiseError=True,scrollIntoView=True)
